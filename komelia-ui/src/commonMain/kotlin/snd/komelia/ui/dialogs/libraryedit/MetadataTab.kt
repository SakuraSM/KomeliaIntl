...
private fun ComicInfoSettings(
    ...
    Column {
        ChildSwitchingCheckboxWithLabel(
            label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Import metadata for CBR/CBZ containing a ComicInfo.xml file")) },
            children = listOf(
                importComicInfoBook,
        ...
        Column(
            ...
            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Book metadata")) },
                checked = importComicInfoBook.value,
                onCheckedChange = importComicInfoBook.setValue,
            )

            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Series metadata")) },
                checked = importComicInfoSeries.value,
                onCheckedChange = importComicInfoSeries.setValue,
            )

            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Append volume to series title")) },
...
private fun EpubSettings(
    ...
    Column {
        ChildSwitchingCheckboxWithLabel(
            label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Import metadata from EPUB files")) },
            children = listOf(
                importEpubBook,
                importEpubSeries,
            ),
...
private fun MylarSettings(
    ...
    Column {
        Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Import metadata generated by Mylar"))
        Column(Modifier.padding(start = 10.dp)) {
            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Series metadata")) },
...
private fun LocalArtworkSettings(
    ...
    Column {
        Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Import local media assets"))
        Column(Modifier.padding(start = 10.dp)) {
            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Local artwork")) },
...
private fun BarcodeISBNSettings(
    ...
    Column {
        Text(snd.komelia.ui.LocalStrings.current.legacy.forText("Import ISBN within barcode"))
        Column(Modifier.padding(start = 10.dp)) {
            CheckboxWithLabel(
                label = { Text(snd.komelia.ui.LocalStrings.current.legacy.forText("ISBN barcode")) },
