...
private val LightColors = lightColorScheme(
    ...
    surfaceContainerHighest = Color(0xFFDCDDE3),
    surfaceDim = Color(0xFFD9DCE5),
    surfaceBright = Color.White,
    outline = Color(0xFF777985),
    outlineVariant = Color(0xFFD0D1D8),
    error = ErrorLight,
    onError = Color.White,
...
private val DarkColors = darkColorScheme(
    ...
    surfaceContainerHigh = Color(0xFF25272D),
    surfaceContainerHighest = Color(0xFF2E3038),
    surfaceDim = Color(0xFF101114),
    surfaceBright = Color(0xFF353740),
